        ...
        <div className='container mx-auto px-4 md:px-6 z-10 py-16 md:py-8 text-center flex flex-col justify-center justify-items-center h-full'>
          <div className='text-white'>
            ...
            <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold mb-6'>
              Peça Rápido e <span className='text-accent'>Sem Taxas</span>
            </h1>
        ...
        <div className='container mx-auto px-4 md:px-6'>
          <div className='text-center mb-12'>
            ...
            <p className='text-base-content/70 mt-3 max-w-xl mx-auto'>
              Encontre uma variedade de estabelecimentos e serviços essenciais
      ...
      >
        <div className='container mx-auto px-4 md:px-6 text-center'>
          ...
          <p className='text-lg max-w-2xl mx-auto mb-10'>
            Peça delivery e solicite serviços sem pagar taxas extras. Faça seu
            primeiro pedido hoje e descubra por que tantas pessoas escolhem o
            FlyFood.
          </p>
