...
export default function HomeOwner() {
  return (
    <main className='flex flex-col min-h-screen bg-base-100 text-base-content overflow-x-hidden'>
          ...
          <div className='grid md:grid-cols-2 gap-8 md:gap-12 items-center'>
            <div className='text-white'>
              ...
              <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold mb-6'>
                Delivery <span className='text-accent'>Sem Comissões</span> para
                o seu Negócio
              </h1>
              ...
              <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <a href='#como-funciona' className='inline-block'>
                  <button
                    type='button'
                    className='btn btn-outline btn-lg text-white border-white hover:bg-white hover:text-primary w-full'
                  >
            ...
            <div className='hidden lg:flex items-center justify-center'>
              <div className='bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 shadow-2xl w-full max-w-md'>
                ...
                <div className='space-y-4'>
                  ...
                  <button
                    type='button'
                    className='btn btn-accent w-full text-accent-content'
                  >
              ...
              <table className='table w-full'>
                <thead>
                  <tr>
                    ...
                    <th className='bg-primary/10 text-primary text-center'>
                      FlyFood
                    </th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='text-center bg-primary/5'>
                      <span className='flex items-center justify-center gap-2'>
                        <CheckCircle className='w-5 h-5 text-accent' /> Direto e
                        imediato
                      </span>
                    </td>
                    <td className='text-center'>
                  ...
                  <tr>
                    ...
                    <td className='text-center bg-primary/5'>
                      <span className='flex items-center justify-center gap-2'>
                        <CheckCircle className='w-5 h-5 text-accent' /> Controle
                        total
                      </span>
                    </td>
                    <td className='text-center'>
                  ...
                  <tr>
                    ...
                    <td className='text-center bg-primary/5'>
                      <span className='flex items-center justify-center gap-2'>
                        <CheckCircle className='w-5 h-5 text-accent' /> Você
                        define
                      </span>
                    </td>
                    <td className='text-center'>
      ...
      <section
        id='como-funciona'
        className='min-h-screen py-16 bg-base-100 flex items-center'
      >
        <div className='container mx-auto px-4 md:px-6'>
          <div className='text-center mb-12'>
            <span className='bg-primary/10 text-primary px-4 py-1 rounded-full text-sm font-medium'>
          ...
          <div className='grid md:grid-cols-4 gap-8 relative'>
            ...
            <div className='hidden md:block absolute top-1/3 left-0 right-0 h-0.5 bg-base-300 z-0' />
      ...
      <section
        id='vantagens'
        className='min-h-screen py-16 bg-primary text-white flex items-center'
      >
        <div className='container mx-auto px-4 md:px-6'>
          <div className='text-center mb-12'>
          ...
          <div className='grid md:grid-cols-3 gap-8 md:gap-12'>
            {vantagens.map((vantagem) => (
              <div
                key={vantagem.titulo}
                className='flex flex-col items-center text-center p-6 bg-primary-focus/20 rounded-xl backdrop-blur-sm'
              >
            ...
            {depoimentos.map((depoimento) => (
              ...
              >
                <div className='flex gap-1'>
                  {[...Array(5)].map((_, i) => {
                    const key = `estrela-${depoimento.nome}-${i}`
                    return (
                      <Star
                        key={key}
            ...
            {planos.map((plano) => (
              ...
              >
                ...
                <div className='card-body'>
                  <h3 className='card-title text-2xl font-bold justify-center'>
                    {plano.nome}
                  </h3>
                  ...
                  <div className='text-center my-4'>
                    ...
                    <p
                      className={`text-sm mt-1 ${plano.popular ? 'text-white/80' : 'text-base-content/70'}`}
                    >
